...
function paisa_scripts() {
    ...
    wp_enqueue_style( 'index-style', get_template_directory_uri() . '/css/style.css' );
    ...
    wp_enqueue_script( 'index-script', get_template_directory_uri() . '/js/index.js', array(), '20170919', true );
